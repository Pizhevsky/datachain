$(document).ready(() => {
	...
	var svg = d3.select("#charts_candles").append("svg")
	...
	function zoomed() {
		...
		y.domain(transform.rescaleY(yInit).domain());
		yPercent.domain(transform.rescaleY(yPercentInit).domain());
	...
	function draw() {
		svg.select("g.x.axis").call(xAxisTechanIntraday); //.call(xAxis);
